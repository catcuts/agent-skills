...
```bash
python "${SKILL_DIR}/scripts/recap.py"
```

生成指定日期的报告：

```bash
python "${SKILL_DIR}/scripts/recap.py" 2026-02-24
```
...
```bash
python "${SKILL_DIR}/scripts/browser_history.py"
```

生成指定日期的报告：

```bash
python "${SKILL_DIR}/scripts/browser_history.py" 2026-02-24
```

生成今天的报告：

```bash
python "${SKILL_DIR}/scripts/browser_history.py" today
```
