...
**支持平台**: 基于 [Vercel 开源的 skills](https://github.com/vercel-labs/skills)，这些技能示例支持 Opencode、Claude Code、Codex、Cursor 及其他 [23 个工具](https://github.com/vercel-labs/add-skill?tab=readme-ov-file#supported-agents)。
